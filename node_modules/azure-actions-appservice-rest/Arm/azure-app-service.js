        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                var httpRequest = {
                    ...
                    uri: this._client.getRequestUri(`//subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web/sites/{name}/${slotUrl}/sitecontainers/${siteContainer.getName()}?api-version=2014-11-01`, {
                        '{resourceGroupName}': this._resourceGroup,
                        '{name}': this._name,
                    }, null, '2014-11-01')
                };
