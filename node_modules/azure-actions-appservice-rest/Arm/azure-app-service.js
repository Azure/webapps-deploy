...
class AzureAppService {
    ...
    buildDeploymentStatusUrl(deploymentID) {
        var slotUrl = !!this._slot ? `/slots/${this._slot}` : '';
        var baseUrl = `//subscriptions/{subscriptionId}/resourceGroups/${this._resourceGroup}/providers/Microsoft.Web/sites/${this._name}/${slotUrl}/deploymentStatus/${deploymentID}?app-versiom=2022-03-01`;
        return baseUrl;
    }
    _get() {
        return __awaiter(this, void 0, void 0, function* () {
