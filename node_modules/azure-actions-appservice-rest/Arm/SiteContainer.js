...
class SiteContainer {
    ...
    static fromJson(item) {
        var _a, _b, _c, _d;
        return new SiteContainer(item.name, item.image, (_a = item.targetPort) === null || _a === void 0 ? void 0 : _a.toString(), (_b = item.isMain) !== null && _b !== void 0 ? _b : false, item.startupCommand, item.authType, item.userName, item.passwordSecret, item.userManagedIdentityClientId, item.inheritAppSettingsAndConnectionStrings, (_c = item.environmentVariables) === null || _c === void 0 ? void 0 : _c.map((env) => new EnvironmentVariable(env.name, env.value)), (_d = item.volumeMounts) === null || _d === void 0 ? void 0 : _d.map((mount) => new VolumeMount(mount.containerMountPath, mount.volumeSubPath, mount.readOnly)));
    }
}
