...
export declare class VolumeMount {
    ...
    constructor(containerMountPath: string, data: string, readOnly: boolean, volumeSubPath: string);
...
export declare class SiteContainer {
    ...
    constructor(name: string, image: string, targetPort?: string, isMain?: boolean, startupCommand?: string, authType?: AUTH_TYPE, userName?: string, passwordSecret?: string, userManagedIdentityClientId?: string, type?: string, environmentVariables?: EnvironmentVariable[], volumeMounts?: VolumeMount[]);
    getName(): string;
    getImage(): string;
