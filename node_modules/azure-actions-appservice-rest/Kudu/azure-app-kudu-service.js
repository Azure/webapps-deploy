    ...
    zipDeploy(webPackage, queryParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                core.info("Response status code is : " + response.statusCode);
                if (response.statusCode == 200) {
                ...
                core.info("Here, its showning the status code - " + error.statusCode);
                throw new Error("Failed to deploy web package to App Service.\n" + this._getFormattedError(error), statusCode = 500);
            }
        });
    }
    imageDeploy(headers) {
