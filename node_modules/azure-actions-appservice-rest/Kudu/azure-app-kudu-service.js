    ...
    zipDeploy(webPackage, queryParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                core.info("Error response status is = " + error.status);
                core.info("Error response status code is = " + error.statusCode);
                core.info("Error response statusMessage is = " + error.statusMessage);
