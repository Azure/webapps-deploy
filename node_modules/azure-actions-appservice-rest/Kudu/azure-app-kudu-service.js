    ...
    zipDeploy(webPackage, queryParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                core.info("Error response is = " + error);
                core.info("Error response is = " + error.response);
                core.info("Error response is = " + error.response.status);
                core.info("Error response is = " + error.response.statusCode);
