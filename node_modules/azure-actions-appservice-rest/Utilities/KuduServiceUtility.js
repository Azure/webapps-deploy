...
class KuduServiceUtility {
    ...
    deployUsingZipDeploy(packagePath, customMessage) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // var deploymentMessage = 'commit_message:' + `${process.env.GITHUB_MESSAGE}`;
    ...
    _getUpdateHistoryRequest(isDeploymentSuccess, deploymentID, customMessage) {
        ...
        var message = {
            ...
            commit_message: `${process.env.GITHUB_MESSAGE}` ? `${process.env.GITHUB_MESSAGE}`: ''
        };
        var commit_message = `${process.env.GITHUB_MESSAGE}`;
        if (!!customMessage) {
        ...
        var test_message = "hardcoded message";
