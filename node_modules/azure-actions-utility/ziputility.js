...
exports.checkIfFilesExistsInZip = exports.getArchivedEntries = exports.archiveFolderWithExclusions = exports.archiveFolder = exports.unzip = void 0;
...
function archiveFolderWithExclusions(folderPath, targetPath, zipName, excludePatterns = []) {
    return __awaiter(this, void 0, void 0, function* () {
        const defer = Q.defer();
        core.debug('Archiving ' + folderPath + ' to ' + zipName);
...
exports.archiveFolderWithExclusions = archiveFolderWithExclusions;
/**
