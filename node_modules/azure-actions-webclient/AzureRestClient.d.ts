import { WebResponse, WebRequest } from './WebClient';
...
export declare function ToError(response: WebResponse): AzureError;
export declare class ServiceClient {
    ...
    beginRequest(request: WebRequest, tokenArgs?: string[]): Promise<WebResponse>;
    accumulateResultFromPagedResult(nextLinkUrl: string): Promise<ApiResult>;
    getLongRunningOperationResult(response: WebResponse): Promise<WebResponse>;
