...
class DeploymentProviderFactory {
    static getDeploymentProvider(type) {
        if (type === BaseWebAppDeploymentProvider_1.DEPLOYMENT_PROVIDER_TYPES.PUBLISHPROFILE) {
            ...
            if (!!actionparameters_1.ActionParameters.getActionParams().isLinux) {
                if (!!actionparameters_1.ActionParameters.getActionParams().images || !!actionparameters_1.ActionParameters.getActionParams().multiContainerConfigFile) {
