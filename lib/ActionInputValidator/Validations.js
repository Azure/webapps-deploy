...
function validateAppDetails() {
    ...
    if (!!actionParams.appName || (!!actionParams.slotName && actionParams.slotName !== 'production')) {
        ...
        let splitUsername = creds.username.substring(1).split("__");
        let appNameMatch = !actionParams.appName || actionParams.appName === splitUsername[0];
        let slotNameMatch = actionParams.slotName === 'production' || actionParams.slotName === splitUsername[1];
